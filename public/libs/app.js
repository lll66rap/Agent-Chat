...
function parseURLParams() {
    ...
    if(urlParams.has('wifi')) {
        let wifi = document.getElementById("connection");
...
function settingsClicked( /* e */ ) {
    ...
    // let descriptor = {
    //         "category":"savegame",
    //         "action_name":"loadSavegame",
    //         "action_data":{
    //             "savegame_id":"pass_001"
    //         }
    //     };
    //         emitUIInteraction(descriptor);
}
...
function connect() {
    ...
    let connectionUrl = wsUrl.replace('http://', 'ws://').replace('https://', 'wss://');
